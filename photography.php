...
<body>
  ...
  <header>
    ...
    <video src="Hero_main_video.mp4" autoplay muted loop width="1520vh" height="760px"></video>
    
    <div class="pic-msg-container">
       <p>
        We capture the beauty in images which stay with you forever ... and when u see the picture you can enjoy those moments again ...because time pass but memories stays forever
       </p>
    </div>

    <div class="pic-container">
      <div class="text-img" onclick="location.href='prewed.php'">PRE WEDDING</div>
      <div class="text-img" onclick="location.href='wed.php'">WEDDING EVENTS</div>
      <div class="text-img" onclick="location.href='prt.php'">PORTRAITS</div>
      <div class="text-img"  onclick="location.href='baby.php'">BABY SHOWER & PARTY</div>
    </div>
  </header>
